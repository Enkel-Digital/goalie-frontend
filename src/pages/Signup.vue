<template>
  <q-page class="q-pa-lg">
    ...
    <q-btn @click="signUp" width="calc(100% - 6em)" color="green darken-1" dark>
      Sign Up
    </q-btn>
    ...
    <q-btn @click="back" width="calc(100% - 6em)" color="grey" dark>
      back
    </q-btn>
...
export default {
  ...
  methods: {
    ...
    async signUp() {
      ...
      // const loaderRequestID = this.$loader.new(); // @todo
      ...
      try {
        ...
        // this.$loader.clear(loaderRequestID); // @todo
      }
    },
  },
};
